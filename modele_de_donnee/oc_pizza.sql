...
CREATE TABLE IF NOT EXISTS `oc_pizza`.`Mode_Paiement` (
  ...
  `cheque` TINYINT NULL,
  `Commande_id` INT NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS `oc_pizza`.`Menu` (
  ...
  `dessert` INT NULL,
  `prix` FLOAT NOT NULL,
  `Ligne_Commande_id` INT NOT NULL DEFAULT 1,
  `Ligne_Commande_Commande_id` INT NOT NULL DEFAULT 1,
  `Ligne_Commande_Commande_Client_id` INT NOT NULL DEFAULT 1,
